...
09d9bd8 (fix(a11y): add keyboard accessibility to interactive div elements)
      ...
      {selectedEvent && (
        <div
          ...
          aria-label="Close modal"
        >
        <div role="button" tabIndex={0} className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setSelectedEvent(null)} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { setSelectedEvent(null); e.preventDefault(); } }}>
09d9bd8 (fix(a11y): add keyboard accessibility to interactive div elements)
