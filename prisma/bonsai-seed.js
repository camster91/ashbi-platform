/**
 * Bonsai → Agency Hub Migration Seed Script (ESM JS)
 * 
 * Usage:
 *   node prisma/bonsai-seed.js
 * 
 * Order: Clients → Retainers → Invoices → Revenue Snapshots
 */
...
async function main() {
    ...
    const client = await prisma.client.upsert({
      ...
      create: {
        ...
        knowledgeBase: JSON.stringify(
          [c.notes ? { type: 'note', content: c.notes } : null].filter(Boolean)
        ),
      },
    });
  ...
  const retainerData = [
    { bonsaiClientId: '1',  monthlyUsd: 1999, billingDay: 1,  startDate: new Date('2025-06-01'), renewalDate: new Date('2026-06-01') },
    { bonsaiClientId: '2',  monthlyUsd: 2000, billingDay: 5,  startDate: new Date('2025-06-15'), renewalDate: new Date('2026-06-15') },
    { bonsaiClientId: '3',  monthlyUsd: 999,  billingDay: 15, startDate: new Date('2023-11-01'), renewalDate: new Date('2026-03-15') },
    { bonsaiClientId: '4',  monthlyUsd: 1999, billingDay: 20, startDate: new Date('2024-11-01'), renewalDate: new Date('2026-11-01') },
    { bonsaiClientId: '13', monthlyUsd: 900,  billingDay: 10, startDate: new Date('2025-06-15'), renewalDate: new Date('2026-06-15') },
    { bonsaiClientId: '9',  monthlyUsd: 1999, billingDay: 25, startDate: new Date('2025-05-01'), renewalDate: new Date('2026-05-01') },
    { bonsaiClientId: '10', monthlyUsd: 312,  billingDay: 1,  startDate: new Date('2024-10-01'), renewalDate: new Date('2025-10-01') },
    { bonsaiClientId: '37', monthlyUsd: 0,    billingDay: 1,  startDate: new Date('2022-11-01'), renewalDate: new Date('2027-11-01') },
    { bonsaiClientId: '65', monthlyUsd: 2500, billingDay: 19, startDate: new Date('2026-03-10'), renewalDate: new Date('2027-03-10') },
  ];
  ...
  for (const r of retainerData) {
    ...
    await prisma.retainerPlan.upsert({
      ...
      create: {
        clientId,
        tier: String(r.monthlyUsd || 0),
        hoursPerMonth: Math.round((r.monthlyUsd || 0) / 50) || 10,
  ...
  const invoicesData = [
    // Overdue
    { number: '1403', bonsaiClientId: '58', amountUsd: 0,    amountCad: 250,    currency: 'CAD', issueDate: '2025-10-01', dueDate: '2025-10-17', status: 'OVERDUE', notes: 'NO CONTACT. 155 days overdue. Consider write-off.' },
    { number: '1464', bonsaiClientId: '46', amountUsd: 750,  amountCad: 0,      currency: 'USD', issueDate: '2026-01-20', dueDate: '2026-02-20', status: 'OVERDUE', notes: 'Brand Discovery Phase 1. Follow up required.' },
    { number: '1472', bonsaiClientId: '45', amountUsd: 420,  amountCad: 0,      currency: 'USD', issueDate: '2026-02-20', dueDate: '2026-03-06', status: 'OVERDUE', notes: 'Sola branding/dieline.' },
    { number: '1481', bonsaiClientId: '4',  amountUsd: 100,  amountCad: 0,      currency: 'USD', issueDate: '2026-03-15', dueDate: '2026-03-17', status: 'OVERDUE', notes: 'Monthly retainer maintenance. Check payment method.' },
    // Outstanding
    { number: '1478', bonsaiClientId: '65', amountUsd: 2500, amountCad: 0,      currency: 'USD', issueDate: '2026-03-10', dueDate: '2026-04-19', status: 'SENT',    notes: 'New retainer. First invoice.' },
    { number: '1479', bonsaiClientId: '39', amountUsd: 500,  amountCad: 0,      currency: 'USD', issueDate: '2026-03-15', dueDate: '2026-03-23', status: 'SENT',    notes: 'Side Deck project.' },
    { number: '1480', bonsaiClientId: '59', amountUsd: 200,  amountCad: 0,      currency: 'USD', issueDate: '2026-03-15', dueDate: '2026-03-23', status: 'SENT',    notes: 'Dieline work.' },
    { number: '1483', bonsaiClientId: '60', amountUsd: 100,  amountCad: 0,      currency: 'USD', issueDate: '2026-03-15', dueDate: '2026-03-24', status: 'SENT',    notes: 'Minor dieline update.' },
    // Drafts
    { number: '1236', bonsaiClientId: '17', amountUsd: 0,    amountCad: 1650,   currency: 'CAD', issueDate: '2025-12-01', dueDate: null, status: 'DRAFT', notes: 'Production work. Follow up on timing.' },
    { number: '1439', bonsaiClientId: '17', amountUsd: 0,    amountCad: 1700,   currency: 'CAD', issueDate: '2026-02-15', dueDate: null, status: 'DRAFT', notes: 'Retainer/production continuation.' },
    { number: '1446', bonsaiClientId: '64', amountUsd: 500,  amountCad: 0,      currency: 'USD', issueDate: '2026-02-20', dueDate: null, status: 'DRAFT', notes: 'Rendering work. Ready to send.' },
    { number: '1458', bonsaiClientId: '36', amountUsd: 0,    amountCad: 445.01, currency: 'CAD', issueDate: '2026-02-28', dueDate: null, status: 'DRAFT', notes: 'Web design work. Client awaiting invoice.' },
    { number: '1465', bonsaiClientId: '46', amountUsd: 0,    amountCad: 750,    currency: 'CAD', issueDate: '2026-02-20', dueDate: null, status: 'DRAFT', notes: 'Brand Discovery Phase 2.' },
    { number: '1466', bonsaiClientId: '46', amountUsd: 0,    amountCad: 750,    currency: 'CAD', issueDate: '2026-02-20', dueDate: null, status: 'DRAFT', notes: 'Brand Discovery Phase 3.' },
    { number: '1473', bonsaiClientId: '45', amountUsd: 0,    amountCad: 50,     currency: 'CAD', issueDate: '2026-03-10', dueDate: null, status: 'DRAFT', notes: 'Minor production support.' },
    // Paid (recent sample)
    { number: '1475', bonsaiClientId: '1',  amountUsd: 2500, amountCad: 0, currency: 'USD', issueDate: '2026-03-01', dueDate: '2026-03-05', paidDate: '2026-03-05', status: 'PAID', method: 'credit_card' },
    { number: '1476', bonsaiClientId: '2',  amountUsd: 2000, amountCad: 0, currency: 'USD', issueDate: '2026-03-05', dueDate: '2026-03-10', paidDate: '2026-03-10', status: 'PAID', method: 'credit_card' },
    { number: '1477', bonsaiClientId: '3',  amountUsd: 999,  amountCad: 0, currency: 'USD', issueDate: '2026-03-08', dueDate: '2026-03-12', paidDate: '2026-03-12', status: 'PAID', method: 'credit_card' },
    { number: '1482', bonsaiClientId: '13', amountUsd: 900,  amountCad: 0, currency: 'USD', issueDate: '2026-03-12', dueDate: '2026-03-15', paidDate: '2026-03-15', status: 'PAID', method: 'credit_card' },
    { number: '1484', bonsaiClientId: '2',  amountUsd: 2000, amountCad: 0, currency: 'USD', issueDate: '2026-03-15', dueDate: '2026-03-18', paidDate: '2026-03-18', status: 'PAID', method: 'credit_card' },
    { number: '1470', bonsaiClientId: '10', amountUsd: 312,  amountCad: 0, currency: 'USD', issueDate: '2026-02-28', dueDate: '2026-03-03', paidDate: '2026-03-03', status: 'PAID', method: 'credit_card' },
    { number: '1471', bonsaiClientId: '10', amountUsd: 400,  amountCad: 0, currency: 'USD', issueDate: '2026-03-01', dueDate: '2026-03-05', paidDate: '2026-03-05', status: 'PAID', method: 'credit_card' },
    { number: '1474', bonsaiClientId: '13', amountUsd: 900,  amountCad: 0, currency: 'USD', issueDate: '2026-02-28', dueDate: '2026-03-05', paidDate: '2026-03-05', status: 'PAID', method: 'credit_card' },
  ];
  ...
  for (const inv of invoicesData) {
    ...
    try {
      ...
      console.warn(`⚠️ Invoice ${inv.number} error:`, e.message);
    }
  }
  ...
  const revenueData = [
    ...
    { month: '2026-03', revenueUsd: 4000,  mrr: 11400 },
  ];

  let snapshotCount = 0;
  for (const r of revenueData) {
    try {
      // Use createMany-style with findFirst to avoid null clientId composite key issue
      const existing = await prisma.revenueSnapshot.findFirst({
        where: { month: r.month, clientId: null },
      });
      if (!existing) {
        await prisma.revenueSnapshot.create({
          data: {
            ...
            projectRevenue: Math.max(0, r.revenueUsd - r.mrr),
            exchangeRateUsedCadUsd: 0.80,
          },
        });
        snapshotCount++;
      } else {
        console.log(`  ↩️  Snapshot ${r.month} already exists, skipping`);
      }
    } catch (e) {
      console.warn(`⚠️ Revenue snapshot ${r.month} error:`, e.message);
    }
  }

  console.log(`✅ Seeded ${snapshotCount} revenue snapshots`);
...
Summary:
  ...
  ✅ Revenue snapshots: ${snapshotCount}
  `);
}
