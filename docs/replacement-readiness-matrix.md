...
| Slack: internal/client conversation | Chat, inbox, realtime notifications, AI chat | Partial; Slack bridge deferred | Channel/thread parity decision, message delivery/retry evidence, notification preferences, retention decision |
...
3. Produce a repeatable authenticated dogfood checklist and attach target evidence per row.
4. Re-run production health, security, browser, and rollback verification after each deployed slice.
