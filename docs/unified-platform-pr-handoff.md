...
npm run lint                                PASS
npm test                                    PASS, 949 backend unit tests
npm run test:all                            PASS, 962 passed, 0 failed, 4 dedicated-database tests skipped; exact-SHA isolated rerun pending
