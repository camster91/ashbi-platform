...
| Invoice/payment | An approved invoice leads to a Stripe test payment; the webhook is processed once, a duplicate delivery is idempotent, and the final invoice/ledger state matches Stripe. |
