...
| --- | --- | --- |
| Slack | Mapped-channel inbound events to project chat with durable reply-thread reconciliation; installation/mapping administration; confirmed mapped outbound post | Outbound thread/channel parity, outbound retry/recovery policy, broad history search, retention policy, and sandbox approval |
