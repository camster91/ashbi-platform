...
| Google Calendar sync | Outbound data model and idempotent adapter code-present; validation/provider access pending | Ashbi-authoritative create/update mapping is committed; OAuth lifecycle, event dispatch, conflict/delete policy, and sandbox evidence remain under [#287](https://github.com/camster91/ashbi-platform/issues/287) |
