...
| Organization BYOK AI provider, budgets and kill switches | Code-present (slice 1 of [#413](https://github.com/camster91/ashbi-platform/issues/413)); not provider or target verified | [ai-byok.md](ai-byok.md): encrypted OpenAI-compatible key per organization, validation before storage, month-to-date metering against a budget, organization and deployment kill switches, audited admin actions. Policy numbers are proposals; tool registry, approval queue and adversarial evaluation are slice 2 |
