...
```text
node scripts/import-bonsai-full.js --dry-run --organization-id <sandbox-org-id> --csv-dir <bonsai-export> --tasks-json <bonsai-tasks.json> --summary-file <new-dry-run-report.json>
```
...
```text
node scripts/import-bonsai-full.js --confirm --organization-id <sandbox-org-id> --csv-dir <bonsai-export> --tasks-json <bonsai-tasks.json> --approved-summary <reviewed-dry-run-report.json> --summary-file <new-live-report.json>
```
