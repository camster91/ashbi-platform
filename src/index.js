...
import migrationReviewRoutes from './routes/migration-review.routes.js';
import launchReadinessRoutes from './routes/launch-readiness.routes.js';
...
await fastify.register(migrationReviewRoutes, { prefix: '/api/migration-reviews' });
await fastify.register(launchReadinessRoutes, { prefix: '/api/launch-readiness' });
