...
if (Object.values(paths).some(value => !value) || !recordPath) {
  process.stderr.write('Usage: npm run verify:bonsai-live-reconciliation-status -- --task-review <json> --mapping-decision <json> --owner-decision <json> --native-project-review <json> --project-link-decision <json> --active-project-triage <json> --financial-review <json> --status <json>\n');
  process.exitCode = 2;
} else {
  try {
